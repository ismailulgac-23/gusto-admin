...
const ProcessSmsView = ({ isCreate = false }) => {
  ...
  return (
    <div>
      ...
      <PageBreadcrumb pageTitle={isCreate ? "SMS Şablonu Oluştur" : "SMS Şablonu Düzenle"} onCreate={isCreate ? () => { } : undefined} onSave={isCreate ? undefined : () => { }} />
